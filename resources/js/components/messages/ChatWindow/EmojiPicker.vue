    ...
    <div class="wrapper">
        <emoji-picker :search="search" @emoji="append">
            <div class="svg-button"
                ...
                <svg-icon name="emoji" :param="emojiReaction ? 'reaction' : ''"></svg-icon>
            </div>

            <div v-if="emojiOpened" slot="emoji-picker" slot-scope="{ emojis, insert }">
                            ...
                            <div v-for="(emojiGroup, category) in emojis" :key="category">
                                ...
                                <div v-if="category !== 'Frequently used'" class="emojis">
                                    <span v-for="(emoji, emojiName) in emojiGroup"
                                          :key="emojiName"
                                          :title="emojiName"
                                          @click="insert({ emoji, emojiName })">{{ emoji }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
