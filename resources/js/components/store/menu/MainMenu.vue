<template>
    <div class="container menu-container" :style="{ height: styleHeight() }">
                ...
                <div role="tablist" class="accordion">
                    <b-card class="menu-block-item" no-body>
                        <b-card-header role="tab" class="menu-block-item-header">
                            <div @click="$router.push({ name: 'store.chat.messages' })">
                    ...
                    <b-card class="menu-block-item" no-body>
                        <b-card-header role="tab" class="menu-block-item-header">
                            <div @click="$router.push({ name: 'store.history.purchase.list' })">
                                <span class="menu-first-icon h2">
                                    <i class="fas fa-list"></i>
                                </span>
                                <h4 class="menu-block-title">購入履歴</h4>
                                <span class="menu-last-icon h3">
                                    <i class="fas fa-chevron-right"></i>
                                </span>
                            </div>
                    ...
                    <b-card class="menu-block-item" no-body>
                        <b-card-header role="tab" class="menu-block-item-header">
                            <div @click="$router.push({ name: 'store.catalog.list' })">
                                <span class="menu-first-icon h2">
                                    <i class="fas fa-bookmark"></i>
                                </span>
                                <h4 class="menu-block-title">オンラインカタログ</h4>
                                <span class="menu-last-icon h3">
                                    <i class="fas fa-chevron-right"></i>
                                </span>
                            </div>
                    ...
                    <b-card class="menu-block-item" no-body>
                        ...
                        <b-collapse id="accordion-settings" accordion="my-accordion" role="tabpanel">
                            <b-card-body class="menu-block-item-body">
                                <ul>
                                    <li>
                                        <b-link :to="{ name: 'store.change.email' }">メールアドレスの登録</b-link>
                                    </li>
                                    <li>
                                        <b-link :to="{ name: 'store.change.password' }">パスワードの変更</b-link>
                                    </li>
                                </ul>
                            </b-card-body>
                        </b-collapse>
