                            ...
                            <div class="form-horizontal">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">{{$options.setting.fieldTxt.newsgroupname}}</label>
                                        <div class="col-sm-10">
                                            <validation-provider
                                                ...
                                                <input
                                                    ...
                                                    type="text"
                                                    class="form-control"
                                                    :placeholder="$options.setting.fieldTxt.name_placeholder">
                                                <span class="text-red">{{ errors[0] }}</span>
                                            </validation-provider>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">{{$options.setting.fieldTxt.description}}</label>
                                        <div class="col-sm-10">
                                            <validation-provider
                                                ...
                                                <textarea
                                                    ...
                                                    class="form-control"
                                                    :placeholder="$options.setting.fieldTxt.description_placeholder"></textarea>
                                                <span
