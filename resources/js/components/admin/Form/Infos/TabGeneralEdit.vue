  ...
  <div class="tab-content">
    ...
    <div class="form-group required">
      ...
      <div class="col-sm-10 " >
        ...
        <select class="form-control" id="selecting-tac-gia" @change="onChange($event)" v-model="selected_tac_gia_edit">
...
export var DOMAIN = SP[0]
export var infoID=SP.at(-1)
export var _selected_tac_gia_edit=0
export default {
  name: 'TabGeneralForm',
  components: {
    tinymce,
  ...
  methods: {
    ...
    onChange(event) {
            _selected_tac_gia_edit= event.target.value
        },
    getTacgiasList(){
      var self = this
