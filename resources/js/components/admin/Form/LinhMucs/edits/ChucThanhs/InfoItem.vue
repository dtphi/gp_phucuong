<template>
    <tr>
            ...
            <validation-provider v-show="isEdit"
                ...
                <select class="form-control"
                    ...
                    <option 
                        ...
                        :value="idx?idx:''" v-for="(item, idx) in $options.setting.cf.chucThanhs" 
                        :key="idx">{{item}}</option>
                </select>
        ...
        <td>
            ...
            <input  v-show="isEdit" type="text" class="form-control"
        ...
        <td>
            ...
            <textarea  v-show="isEdit" class="form-control"
        ...
        <td class="text-right">
            <button  v-show="isEdit" @click="_updateChucThanhForm()"
                    type="button" 
                    data-toggle="tooltip"
                    title="Cập nhật chức thánh" class="btn btn-primary cms-btn">
                    <i class="fa fa-save"></i>
            </button>
            <button @click="_openEditForm"
                    type="button" 
                    data-toggle="tooltip"
                    title="Sửa chức thánh" class="btn btn-default cms-btn">
