        ...
        <tr v-if="item.isEdit">    
            ...
            <td class="text-right">
                <button @click="_openEditForm"
                        type="button" 
                        data-toggle="tooltip"
                        title="Cập nhật thuyên chuyển" class="btn btn-default cms-btn">
                ...
                <table class="table table-striped table-bordered table-hover">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="4" class="text-right">
                                <button @click="_updateThuyenChuyenForm(item)"
                                        type="button" 
                                        data-toggle="tooltip"
                                        title="Cập nhật thuyên chuyển" class="btn btn-primary cms-btn">
