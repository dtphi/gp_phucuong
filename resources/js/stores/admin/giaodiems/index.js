...
import {
  ...
  apiGetGiaoDiemInfos,
  apiDeleteInfo,
} from 'api@admin/giaodiem'
import { MODULE_MODULE_GIAO_DIEM, } from '../types/module-types'
import {
  INFOS_SET_LOADING,
...
export default {
  ...
  actions: {
    ...
    [`${MODULE_MODULE_GIAO_DIEM}_${ACTION_RELOAD_GET_INFO_LIST}`]: {
      root: true,
      handler(namespacedContext, payload) {
        if (isNaN(payload)) {
          return fn_redirect_url(`/${config.adminPrefix}/giao-diems`)
        } else {
