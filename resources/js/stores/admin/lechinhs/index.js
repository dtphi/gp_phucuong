...
import { apiGetInfoById, apiGetInfos, apiDeleteInfo, } from 'api@admin/lechinh'
import { MODULE_MODULE_LE_CHINH, } from '../types/module-types'
import {
  INFOS_SET_LOADING,
  ...
  actions: {
    ...
    [MODULE_MODULE_LE_CHINH + '_' + ACTION_RELOAD_GET_INFO_LIST]: {
      ...
      handler(namespacedContext, payload) {
        if (isNaN(payload)) {
          return fn_redirect_url(`/${config.adminPrefix}/le-chinhs`)
        } else {
