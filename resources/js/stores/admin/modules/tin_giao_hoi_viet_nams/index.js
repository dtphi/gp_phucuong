...
const settingCategory = {
  key: 'module_tin_giao_hoi_viet_nam_categories',
  value: [],
  serialize: true,
}
...
export default {
  ...
  mutations: {
    ...
    [MODULE_UPDATE_RESET_SETTING_CATEGORY_VALUE_DATA](state, payload) {
      state.module_tin_giao_hoi_viet_nam_categories.value = payload
    },

    [MODULE_UPDATE_SET_KEYS_DATA](state, payload) {
      state.module_tin_giao_hoi_viet_nam_categories =
                payload.module_tin_giao_hoi_viet_nam_categories
      state.moduleData.keys = []
      state.moduleData.keys.push(
        payload.module_tin_giao_hoi_viet_nam_categories
      )
    },
        ...
        (res) => {
          if (Object.keys(res.data.results).length) {
            ...
            dispatch(
              ACTION_GET_CATEGORY_LIST_BY_IDS,
              res.data.results
                .module_tin_giao_hoi_viet_nam_categories.value
            )
          }
