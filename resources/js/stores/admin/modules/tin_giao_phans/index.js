...
export default {
  ...
  mutations: {
    ...
    [MODULE_UPDATE_SET_KEYS_DATA](state, payload) {
      state.module_tin_giao_phan_categories = payload.module_tin_giao_phan_categories;
      ...
      apiGetSettingByCode(
        ...
        (res) => {
          if (Object.keys(res.data.results).length) {
            ...
            dispatch(ACTION_GET_CATEGORY_LIST_BY_IDS, res.data.results.module_tin_giao_phan_categories.value);
          } else {
