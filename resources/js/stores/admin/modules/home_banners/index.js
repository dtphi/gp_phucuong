...
export default {
  ...
  mutations: {
    ...
    [MODULE_UPDATE_SET_KEYS_DATA](state, payload) {
      if (fnCheckProp(payload, 'module_banner_audio_podcasts')) {
        state.img_audio_podcast =
                    payload.module_banner_audio_podcasts.value.image
        state.title_audio_podcast =
                    payload.module_banner_audio_podcasts.value.title
        state.url_audio_podcast =
                    payload.module_banner_audio_podcasts.value.url
        state.sort_audio_podcast =
                    payload.module_banner_audio_podcasts.value.sort
      }
      if (fnCheckProp(payload, 'module_banner_giao_xus')) {
      ...
      if (fnCheckProp(payload, 'module_banner_linh_mucs')) {
        state.img_linh_muc = payload.module_banner_linh_mucs.value.image
        state.title_linh_muc =
                    payload.module_banner_linh_mucs.value.title
      ...
      if (fnCheckProp(payload, 'module_banner_loi_chuas')) {
        state.img_loi_chua = payload.module_banner_loi_chuas.value.image
        state.title_loi_chua =
                    payload.module_banner_loi_chuas.value.title
      ...
      if (fnCheckProp(payload, 'module_banner_on_gois')) {
      ...
      if (fnCheckProp(payload, 'module_banner_phung_vus')) {
        state.img_phung_vu = payload.module_banner_phung_vus.value.image
        state.title_phung_vu =
                    payload.module_banner_phung_vus.value.title
      ...
      if (fnCheckProp(payload, 'module_banner_thong_baos')) {
        state.img_thong_bao =
                    payload.module_banner_thong_baos.value.image
        state.title_thong_bao =
                    payload.module_banner_thong_baos.value.title
        state.url_thong_bao = payload.module_banner_thong_baos.value.url
        state.sort_thong_bao =
                    payload.module_banner_thong_baos.value.sort
      }
      if (fnCheckProp(payload, 'module_banner_videos')) {
