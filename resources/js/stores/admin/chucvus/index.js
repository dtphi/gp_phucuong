...
import { apiGetInfoById, apiGetInfos, apiDeleteInfo, } from 'api@admin/chucvu'
import { MODULE_MODULE_CHUC_VU, } from '../types/module-types'
import {
  INFOS_SET_LOADING,
  ...
  actions: {
    ...
    [MODULE_MODULE_CHUC_VU + '_' + ACTION_RELOAD_GET_INFO_LIST]: {
      ...
      handler(namespacedContext, payload) {
        if (isNaN(payload)) {
          return fn_redirect_url(`/${config.adminPrefix}/chuc-vus`)
        } else {
