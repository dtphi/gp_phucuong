<template>
  <form class="form-horizontal">
    ...
    <ul class="nav nav-tabs">
      <li class="active">
        <a href="#tab-sach-noi" data-toggle="tab">{{
          $options.setting.tab_sach_noi_title
        }}</a>
      </li>
      <li>
        <a href="#tab-youtube" data-toggle="tab">{{
          $options.setting.tab_youtube_title
        }}</a>
      </li>
      <li>
        <a href="#tab-hanh-cac-thanh" data-toggle="tab">{{
          $options.setting.tab_hanh_cac_thanh_title
        }}</a>
      </li>
      <li>
        <a href="#tab-banner" data-toggle="tab">{{
          $options.setting.tab_banner_title
        }}</a>
      </li>
    </ul>
