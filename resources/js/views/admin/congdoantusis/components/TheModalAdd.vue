<template>
    <modal name="modal-cong-doan-tu-si-add" :height="455">
        <div class="panel panel-default" style="height:100%;overflow:auto">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-plus"></i>Thêm công đoàn tu sĩ</h3>
            ...
            <div class="panel-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="input-info-name" class="col-sm-2 control-label">Tên công đoàn</label>
                        <div class="col-sm-10">
                            <validation-provider
                            name="info_name"
                            rules="max:255"
...
<script>
    ...
    export default {
        ...
        methods: {
            _hideModalEdit() {
                this.info = {};
                this.$modal.hide('modal-cong-doan-tu-si-add');
            },
            _submitUpdate() {
                return 0;
            },
