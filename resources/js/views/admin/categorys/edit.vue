          ...
          <div class="container-fluid">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-list"></i>Sửa nhóm tin</h3>
              </div>
                  ...
                  <div class="tab-content">
                    <div class="tab-pane active" id="tab-general">
                      <div class="tab-content">
                          <div class="form-group required">
                            ...
                            <div class="col-sm-10">
                              <input type="text" v-model="newsGroup.category_name" placeholder="Tên nhóm tin" id="input-name" class="form-control">
                            </div>
                          </div>
                          ...
                          <div class="form-group required">
                            ...
                            <div class="col-sm-10">
                              <input type="text" v-model="newsGroup.meta_title" placeholder="Meta title" id="input-meta-title" class="form-control">
                            </div>
                          </div>
                      </div>
                    </div>
                    <div class="tab-pane" id="tab-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" v-model="newsGroup.sort_order" name="sort_order" placeholder="Thứ tự hiển thị" id="input-sort-order" class="form-control" />
                        </div>
                      </div>
                      <div class="form-group">
