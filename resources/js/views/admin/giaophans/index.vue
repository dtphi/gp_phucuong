                  ...
                  <table class="table table-bordered table-hover">
                    <thead>
                      <tr role="row">
                        ...
                        <th style="width: 25%" class="text-left">Khái quát</th>
                        <th style="width: 10%" class="text-center">Sắp xếp</th>
...
export default {
  ...
  computed: {
    ...
    ...mapState(MODULE_MODULE_GIAO_PHAN, ['infos', 'loading', 'updateSuccess']),
    _infoList() {
      return this.infos
    },
    _notEmpty() {
