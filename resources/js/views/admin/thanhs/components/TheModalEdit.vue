    ...
    <div class="panel panel-default" style="height:100%;overflow:auto">
        <div class="panel-heading">
            <h3 class="panel-title">
                <i class="fa fa-edit"></i>Cập nhật tên thánh</h3>
        ...
        <div class="panel-body">
            <form class="form-horizontal">
                <div class="form-group">
                    <label for="input-info-name" class="col-sm-2 control-label">Tên thánh</label>
                    <div class="col-sm-10">
                        <validation-provider
                        name="info_name"
                        rules="max:255"
                ...
                <div class="form-group">
                    <label for="input-info-name" class="col-sm-2 control-label">Latin</label>
                    <div class="col-sm-10">
                        <validation-provider
                        name="info_name"
                        rules="max:255"
                ...
                <div class="form-group">
                    <label for="input-info-name" class="col-sm-2 control-label">Bổn mạng</label>
                    <div class="col-sm-10">
                        <cms-date-picker
                            value-type="format"
                            format="YYYY-MM-DD"
                ...
                <div class="form-group">
                    <label for="input-info-name" class="col-sm-2 control-label">Cuộc đời</label>
                    <div class="col-sm-10">
                        <validation-provider
                        name="info_ghi_chu"
                        rules="max:200"
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapState(MODULE_MODULE_THANH_EDIT, [
                'loading',
                'updateSuccess'
            ])
        },
