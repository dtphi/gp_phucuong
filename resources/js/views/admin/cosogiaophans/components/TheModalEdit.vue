<template>
    <modal name="modal-co-so-edit" :height="455">
        <div class="panel panel-default" style="height:100%;overflow:auto">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-edit"></i>Cập nhật cơ sở</h3>
            ...
            <div class="panel-body">
                <form class="form-horizontal">
                    <div class="form-group">
                        <label for="input-info-name" class="col-sm-2 control-label">Giáo phận</label>
                        <div class="col-sm-10">
                            {{info.ten_linh_muc}}
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input-info-name" class="col-sm-2 control-label">Tên cơ sở</label>
                        <div class="col-sm-10">
                            <validation-provider
                            name="info_name"
                            rules="max:255"
                    ...
                    <div class="form-group">
                        <label for="input-info-name" class="col-sm-2 control-label">Địa chỉ</label>
                        <div class="col-sm-10">
                            <validation-provider
                            name="info_name"
                            rules="max:255"
                    ...
                    <div class="form-group">
                        <label for="input-info-name" class="col-sm-2 control-label">Email</label>
                        <div class="col-sm-10">
                            <validation-provider
                            name="info_name"
                            rules="max:255"
                    ...
                    <div class="form-group">
                        <label for="input-info-name" class="col-sm-2 control-label">Điện thoại</label>
                        <div class="col-sm-10">
                            <validation-provider
                            name="info_name"
                            rules="max:255"
                    ...
                    <div class="form-group">
                        <label for="input-info-name" class="col-sm-2 control-label">Fax</label>
                        <div class="col-sm-10">
                            <validation-provider
                            name="info_name"
                            rules="max:255"
                    ...
                    <div class="form-group">
                        <label for="input-info-name" class="col-sm-2 control-label">Website</label>
                        <div class="col-sm-10">
                            <validation-provider
                            name="info_name"
                            rules="max:255"
