<template>
    <modal name="modal-giao-diem-add" :height="455">
        <div class="panel panel-default" style="height:100%;overflow:auto">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-plus"></i>Thêm giáo điểm</h3>
            ...
            <div class="panel-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="input-info-name" class="col-sm-2 control-label">Giáo hạt</label>
                        <div class="col-sm-10">
                            {{info.ten_linh_muc}}
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input-info-name" class="col-sm-2 control-label">Giáo xứ</label>
                        <div class="col-sm-10">
                            {{info.ten_linh_muc}}
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input-info-name" class="col-sm-2 control-label">Tên giáo điểm</label>
                        <div class="col-sm-10">
                            <validation-provider
                            name="info_name"
                            rules="max:255"
...
<script>
    ...
    export default {
        ...
        methods: {
            _hideModalEdit() {
                this.info = {};
                this.$modal.hide('modal-giao-diem-add');
            },
            _submitUpdate() {
                return 0;
            },
