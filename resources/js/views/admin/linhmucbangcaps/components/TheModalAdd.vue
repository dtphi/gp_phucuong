  ...
  <modal name="modal-linh-muc-bang-cap-add" :height="455">
    <div class="panel panel-default" style="height: 100%; overflow: auto">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-plus"></i>Thêm bằng cấp</h3>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select class="form-control" v-model="infoUpdate.type">
                <option value="0" :selected="infoUpdate.type == 0">
                  Loại 1
                </option>
                <option value="1" :selected="infoUpdate.type == 1">
                  Loại 2
                </option>
              </select>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select class="form-control" v-model="infoUpdate.active">
                <option value="1" :selected="infoUpdate.active == 1">
                  Xảy ra
                </option>
