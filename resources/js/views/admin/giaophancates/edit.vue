          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title">
                <i class="fa fa-list"></i>Sửa nhóm tin
              </h3>
            </div>
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="tab-data">
                    <category-autocomplete
                      :category-id="newsGroup.parent_id"
                    ></category-autocomplete>
                    <div class="form-group">
                      <label
                        class="col-sm-2 control-label"
...
import { MODULE_MODULE_DANHMUC_GIAOPHAN_EDIT, } from 'store@admin/types/module-types'
import {
...
export default {
  ...
  beforeCreate() {
    ...
    if (!cateId) {
      window.location.href = `${window.origin}/${this.$cmsCfg.adminPrefix}/giao-phan/danh-mucs`
    }
  },
  components: {
    TheBtnBackListPage,
  ...
  computed: {
    ...mapState(MODULE_MODULE_DANHMUC_GIAOPHAN_EDIT, {
  ...
  methods: {
    ...mapActions(MODULE_MODULE_DANHMUC_GIAOPHAN_EDIT, [
      ACTION_GET_NEWS_GROUP_BY_ID,
      ACTION_RESET_NOTIFICATION_INFO,
      ACTION_UPDATE_NEWS_GROUP
    ]),
