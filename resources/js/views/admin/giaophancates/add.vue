                ...
                <div class="tab-content">
                      ...
                      <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                          ...
                          >
                            <input
                              type="text"
                              v-model="newsGroupAdd.meta_title"
                  ...
                  <div class="tab-pane" id="tab-data">
                    <category-autocomplete
                      :category-id="newsGroupAdd.parent_id"
                    ></category-autocomplete>
                    <div class="form-group">
                      <label
                        class="col-sm-2 control-label"
                        for="input-category-sort-order"
                        >Thứ tự</label
                      >
                      <div class="col-sm-10">
                        <validation-provider
                        ...
                        >
                          <input
                            type="text"
                            v-model="newsGroupAdd.sort_order"
                            name="sort_order"
                            placeholder="Thứ tự hiển thị"
                            id="input-category-sort-order"
                            class="form-control"
                          />
                          <span class="cms-text-red">{{ errors[0] }}</span>
                        </validation-provider>
                    ...
                    <div class="form-group">
                      <label
                        class="col-sm-2 control-label"
                        for="input-category-status"
                        >Trạng thái</label
                      >
                      <div class="col-sm-10">
                        <select
                          v-model="newsGroupAdd.status"
                          id="input-category-status"
                          class="form-control"
                        >
                      ...
                      <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                          <tr>
                            <td class="text-left">
                              <select
                                v-model="newsGroupAdd.layout_id"
                                class="form-control"
                              >
...
import CategoryAutocomplete from 'com@admin/Search/DanhMucsAutocomplete'
...
export default {
  ...
  computed: {
    ...mapState(MODULE_MODULE_DANHMUC_GIAOPHAN_ADD, {
      loading: state => state.loading,
      errors: state => state.errors,
    }),
    ...mapGetters(MODULE_MODULE_DANHMUC_GIAOPHAN_ADD, [
      'newsGroupAdd',
      'insertSuccess'
    ]),
    _errors() {
  ...
  methods: {
    ...
    async _submitInfo() {
      await this.$refs.observerGiaoPhanDanhMucs.validate().then(isValid => {
        if (isValid) {
