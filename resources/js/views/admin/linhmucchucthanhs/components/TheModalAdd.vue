<template>
  <modal name="modal-linh-muc-chuc-thanh-add" :height="455">
    <div class="panel panel-default" style="height: 100%; overflow: auto">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-plus"></i>Thêm chức thánh</h3>
...
export default {
  ...
  methods: {
    _hideModalEdit() {
      this.info = {}
      this.$modal.hide('modal-linh-muc-chuc-thanh-add')
    },
    _submitUpdate() {
      return 0
    },
