  ...
  <div class="panel panel-default" style="height: 100%; overflow: auto">
    <div class="panel-heading">
      <h3 class="panel-title">
        <i class="fa fa-edit"></i>Cập nhật thuyên chuyển
      </h3>
...
import { MODULE_MODULE_THUYEN_CHUYEN_EDIT, } from 'store@admin/types/module-types'
import {
  ACTION_UPDATE_INFO,
...
export default {
  ...
  computed: {
    ...mapState(MODULE_MODULE_THUYEN_CHUYEN_EDIT, ['loading', 'updateSuccess']),
  },
  watch: {
