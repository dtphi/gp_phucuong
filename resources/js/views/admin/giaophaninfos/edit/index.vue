...
import InfoEditForm from 'com@admin/Form/GiaoPhanTinTucs/EditForm'
...
export default {
  ...
  beforeCreate() {
    ...
    if (!infoId) {
      return fn_redirect_url('admin/giao-phan/tin-tucs')
    }
  },
  data() {
    return {
  ...
  updated() {
    ...
    if (this.isNotExistValidate) {
      fn_redirect_url('admin/giao-phan/tin-tucs')
    }
  },
  computed: {
    ...
    ...mapGetters(MODULE_MODULE_TINTUC_GIAOPHAN_EDIT, ['isNotExistValidate']),
    _errors() {
  ...
  setting: {
    panel_title: 'Tin tức giáo phận',
    frm_title: 'Sửa tin tức giáo phận',
  },
}
</script>
