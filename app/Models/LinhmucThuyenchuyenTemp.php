...
class LinhmucThuyenchuyenTemp extends BaseModel
{
  /**
   * @var string
   */
  protected $table = DB_PREFIX . 'linhmuc_thuyenchuyens_temp';
  ...
  public static function insertByLinhmucId(
    ...
    if ($linhmucId) {
      DB::insert(
        'insert into ' . Tables::$linhmuc_thuyenchuyens . ' (linh_muc_id, from_giao_xu_id, from_chuc_vu_id, from_date, duc_cha_id, to_date, chuc_vu_id, giao_xu_id, co_so_gp_id, dong_id, ban_chuyen_trach_id, du_hoc, quoc_gia, active, ghi_chu) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
