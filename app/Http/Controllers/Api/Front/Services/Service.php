...
class Service implements BaseModel
{
  ...
  public function apiUpdateLinhMucTemp($data = []){
      $linhmuc_temp = LinhmucTemp::updateOrCreate(
        ...
        [
          'id' => $data['params']['id'],
          'ten_thanh_id' => $data['params']['ten_thanh_id'],
          'ten' => $data['params']['ten'],
          'ngay_thang_nam_sinh' => $data['params']['ngay_thang_nam_sinh'] ?? null,
          'noi_sinh' => $data['params']['noi_sinh'],
          'ho_ten_cha' => $data['params']['ho_ten_cha'],
          'ho_ten_me' => $data['params']['ho_ten_me'],
          'noi_rua_toi' => $data['params']['noi_rua_toi'] ?? null,
          'ngay_rua_toi' => $data['params']['ngay_rua_toi'] ?? null,
          'noi_them_suc' => $data['params']['noi_them_suc'] ?? '',
          'ngay_them_suc' => $data['params']['ngay_them_suc'] ?? null,
          'tieu_chung_vien' => $data['params']['tieu_chung_vien'] ?? '',
          'ngay_tieu_chung_vien' => $data['params']['ngay_tieu_chung_vien'] ?? null,
          'dai_chung_vien' => $data['params']['dai_chung_vien'] ?? '',
          'ngay_dai_chung_vien' => $data['params']['ngay_dai_chung_vien'] ?? null,
          'image' => $data['params']['image'],
          'so_cmnd' => $data['params']['so_cmnd'],
          'ngay_cap_cmnd' => $data['params']['ngay_cap_cmnd'] ?? null,
          'noi_cap_cmnd' => $data['params']['noi_cap_cmnd'] ?? '',
          'phone' => $data['params']['phone'] ?? '',
          'email' => $data['params']['email'] ?? '',
          'trieu_dong' => $data['params']['trieu_dong'],
          'ten_dong_id' => $data['params']['ten_dong_id'],
          'ngay_trieu_dong' => $data['params']['ngay_trieu_dong'] ?? null,
          'ngay_khan' => $data['params']['ngay_khan'] ?? null,
          'is_duc_cha' => $data['params']['is_duc_cha'],
          'cham_ngon' => $data['params']['cham_ngon'] ?? '',
          'sinh_giao_xu' => $data['params']['sinh_giao_xu'],
        ]);
        return $linhmuc_temp;
  }
